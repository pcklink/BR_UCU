...
prestim(3).trackstim = 2; % which stimulus should be tracked
...
trialtype(1).time.PrestimT = 5; %s leave empty or set zero for none
trialtype(1).time.PrestimGapT = 0.5; %s between prestim and stim
...
trialtype(3).time.PrestimT = 5; %s leave empty or set zero for none
...
trialtype(9).time.StimT = 5; %s stimulus duration
...
block(1).trials = [1 5]; % which trialtypes in the block
...
block(2).trials = [3 9]; % which trialtypes in the block
...
block(3).trials = [1 5 6]; % which trialtypes in the block
...
block(4).trials = [3 9]; % which trialtypes in the block
