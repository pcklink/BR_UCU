...
trialtype(9) = trialtype(5); % inititate copy, then change necessary things
...
trialtype(10) = trialtype(5); % inititate copy, then change necessary things
...
trialtype(11) = trialtype(5); % inititate copy, then change necessary things
...
% direction
trialtype(12) = trialtype(5); % inititate copy, then change necessary things
