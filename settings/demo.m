...
monitor.DebugMode = 'UU-SETUP';% Debug mode allows subscreen stim display
% set this to 'NoDebug' when running the experiments
% NoDebug / UU / UU-SETUP / CKHOME / CKNIN
...
trialtype(1).time.StimT = 900; %s stimulus duration
